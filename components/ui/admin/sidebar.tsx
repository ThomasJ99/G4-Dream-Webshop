...
export default function Sidebar() {
  ...
  const links = [
    {
      href: "/products",
      icon: <Package2 width={18} height={18} />,
      label: "Products",
    },
    {
      href: "/analytics",
  ...
  return (
    <section className="flex flex-col gap-6 sticky left-0 top-0 h-screen shadow-md border-r  border-gray-300">
      ...
      <footer className="p-6 border-t border-gray-300">
        <button
          type="button"
          className={`hover:bg-gray-100 p-4 rounded-md flex flex-row gap-2 items-center text-left cursor-pointer relative ${isProfileDropdownOpen ? "bg-gray-200 hover:bg-gray-200" : ""}`}
