      ...
      <section className="relative min-h-[85vh] flex items-center">
        ...
        <div className="relative z-9 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 w-full">
          <div className="max-w-2xl space-y-6 text-shadow-md">
            ...
            <Link
              href="/products"
              className="inline-flex items-center gap-4 border border-black bg-black text-white py-2.5 px-5 rounded-lg hover:bg-transparent hover:border-white transition-colors"
            >
